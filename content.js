// content.js V10.1 - Open Source Version
...
function updateUI(data, twBadge, solBadge, address) {
    // 没填 Key 时的提示
    if (data.balance === "NoKey") {
        solBadge.innerText = "Set API Keys"; solBadge.style.backgroundColor = '#000';
        twBadge.innerText = "in background.js"; twBadge.style.backgroundColor = '#000';
        return;
    }
